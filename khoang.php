...
<div class="container mx-auto p-4">
    <h2 id="item-title" class="text-center font-bold text-xl md:text-2xl dark:text-muted-200 mb-4 text-orange-500">DANH SÁCH KHOANG</h2>
            ...
            <div class="w-full relative text-center rounded-lg overflow-hidden uppercase max-w-sm bg-white border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <ul class=" space-y-3 p-4">
                    ...
                    foreach ($styles as $style) { ?>
                        <li>
                            <a href="items.php?ma-hang=<?= $style->item_style ?>&khoang=<?= $container->item_container ?>" class="flex items-center p-3 text-base font-bold text-gray-900 bg-second-100 hover:bg-second-200 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white"><span class="flex-1 ml-3 whitespace-nowrap"><?= $style->item_style ?></span></a>
                        </li>
                    <?php }
                    ?>
                </ul>
