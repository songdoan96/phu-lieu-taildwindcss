...
<div class="max-w-screen-sm mx-auto p-4">
    <form class="rounded bg-white dark:bg-gray-600 shadow shadow-black/30 p-4 mt-8" action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <div class="mb-6">
            ...
            <input type="username" id="username" name="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
        </div>
        <div class="mb-6">
        ...
        <button type="submit" name="login-form" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-800">Đăng nhập</button>
    </form>
</div>
