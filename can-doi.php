                    ...
                    if ($styles) { ?>
                        <ul class=" space-y-3 p-4">
                            <?php foreach ($styles as $style) { ?>
                                <li><a href='can-doi.php?customer=<?= $item->item_customer ?>&style=<?= $style->item_style ?>' class='flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-second-100 hover:bg-second-200 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white'><span class='flex-1 ml-3 whitespace-nowrap'>#<?= $style->item_style ?></span></a></li>
                            <?php }  ?>
                        </ul>
                    <?php }
                    ?>
    ...
    <div class="container mx-auto p-4">
        <form id="form-add-plan" method="POST" action="<?= $_SERVER['PHP_SELF'] ?>" class="bg-white max-w-xl mx-auto p-4 shadow-lg rounded-md">
            ...
            <div class="flex flex-wrap items-center mb-2">
                ...
                <input readonly type="text" id="style" name="style" value="<?= get('style') ?>" class="w-full md:w-3/4 rounded bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-primary-600 focus:border-primary-600 block p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
            </div>
            <div class="flex flex-wrap items-center mb-2">
                <label for="type" class="w-full mb-2 md:mb-0 md:w-1/4 block font-medium text-gray-900 dark:text-black">Mã hàng:</label>
                <input readonly type="text" id="type" name="type" value="<?= get('type') ?>" class="w-full md:w-3/4 rounded bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-primary-600 focus:border-primary-600 block p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
            </div>
            <div class="flex flex-wrap items-center mb-2">
                <label for="color" class="w-full mb-2 md:mb-0 md:w-1/4 block font-medium text-gray-900 dark:text-black">Màu:</label>
                <input readonly type="text" id="color" name="color" value="<?= get('color') ?>" class="w-full md:w-3/4 rounded bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-primary-600 focus:border-primary-600 block p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
            </div>
            <div class="flex flex-wrap items-center mb-2">
                <label for="size" class="w-full mb-2 md:mb-0 md:w-1/4 block font-medium text-gray-900 dark:text-black">Màu:</label>
                <input readonly type="text" id="size" name="size" value="<?= get('size') ?>" class="w-full md:w-3/4 rounded bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-primary-600 focus:border-primary-600 block p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
            </div>
            <div class="flex flex-wrap items-center mb-2">
                <label for="params" class="w-full mb-2 md:mb-0 md:w-1/4 block font-medium text-gray-900 dark:text-black">Màu:</label>
                <input readonly type="text" id="params" name="params" value="<?= get('params') ?>" class="w-full md:w-3/4 rounded bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-primary-600 focus:border-primary-600 block p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
            </div>
            <div class="flex flex-wrap items-center mb-2">
                <label for="plan" class="w-full mb-2 md:mb-0 md:w-1/4 block font-medium text-gray-900 dark:text-black">KHSX:</label>
                <input required type="number" step="0.01" id="plan" name="plan" value="<?= !empty("plan") ? get('plan') : "" ?>" class="w-full md:w-3/4 rounded bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-primary-600 focus:border-primary-600 block p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
            </div>
            <div class="flex flex-wrap items-center mb-2">
                <label for="norm" class="w-full mb-2 md:mb-0 md:w-1/4 block font-medium text-gray-900 dark:text-black">Định mức:</label>
                <input required type="number" step="0.01" id="norm" name="norm" value="<?= !empty("norm") ? get('norm') : "" ?>" class="w-full md:w-3/4 rounded bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-primary-600 focus:border-primary-600 block p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
            </div>
            ...
            <tbody>
                ...
                foreach ($items as $item) { ?>
                    <tr item-id="<?= $item->item_id ?>" class="even:bg-gray-400 odd:bg-gray-200 dark:odd:bg-gray-500 dark:even:bg-gray-600 text-black dark:text-white  dark:border-gray-700 hover:contrast-75 transition">
                        ...
                        <td class="border px-1 py-2"><a class="underline" href="items.php?ma-hang=<?= $item->item_style ?>&type=<?= $item->item_type ?>&color=<?= $item->item_color ?>&size=<?= $item->item_size ?>&params=<?= $item->item_params ?>"><?= $item->item_type ?></a></td>
