        ...
        <table class="w-full border-collapse table-auto text-xs">
            <thead>
                <tr class="bg-gray-300 dark:bg-slate-900/70 dark:text-white text-gray-600 uppercase text-sm leading-normal text-center">
                    ...
                    <th class="py-2 border px-1" style="min-width: 40px;"></th>
            ...
            <tbody>
                ...
                <?php foreach ($items as $item) { ?>
                    <tr class="text-center text-sm odd:bg-gray-50 even:bg-gray-200 hover:bg-gray-300 dark:bg-gray-600  dark:hover:bg-gray-700 dark:text-white transition">
                        ...
                        <td class="border py-2 px-1"><a href="items.php?khoang=<?= $item->item_container ?>"><?= $item->item_container ?></a></td>
                        ...
                        <td class="border py-2 px-1"><a href="items.php?ma-hang=<?= $item->item_style ?>&type=<?= $item->item_type ?>&color=<?= $item->item_color ?>&size=<?= $item->item_size ?>&params=<?= $item->item_params ?>"><?= $item->item_type ?></a></td>
                        ...
                        <td class="border">
                            ...
                            <?php } else { ?>
                                <a class="no-underline flex justify-center text-green-600 dark:text-green-300" href="nhap-kho.php?id=<?= $item->item_id ?>">
                        ...
                        <td class="border">
                            ...
                            <?php } else { ?>
                                <a class="no-underline flex justify-center text-red-600 dark:text-red-300" href="xuat-kho.php?id=<?= $item->item_id ?>">
                                    <svg fill="none" height="16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="16">
                                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                    </svg>
