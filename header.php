        ...
        <div class="container flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2">
                ...
                <?php if (isset($_SESSION['user'])) { ?>
                    ...
                    <form method="get" action="items.php" id="form-search" class="hidden">
                        <div class="flex relative">
                            ...
                            <!-- <div id="form-search-list" class="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 block top-10 absolute hidden" data-popper-placement="bottom"> -->
                            <select name="search-type" id="form-search-list" class="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 block top-10 absolute hidden">
                                <option value="">MÃ HÀNG</option>
                                <option value="">PO</option>
                                <option value="">PHỤ LIỆU</option>
                            </select>
                            <!-- <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                                    <li>
                                        <button type="button" class="font-medium inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">MÃ HÀNG</button>
                                    </li>
                                    <li>
                                        <button type="button" class="font-medium inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">PO</button>
                                    </li>
                                    <li>
                                        <button type="button" class="font-medium inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">PHỤ LIỆU</button>
                                    </li>
