    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex md:order-2">
            ...
            <?php if (isset($_SESSION['user'])) { ?>
                <form method="get" action="items.php" class="hidden md:flex relative overflow-hidden">
                    ...
                    <input type="text" name="search-value" id="search-input" class="h-full rounded-r-lg border p-2"
            ...
            if (!isset($_SESSION['user'])) { ?>
                <a class="ml-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        ...
        <?php if (isset($_SESSION['user'])) { ?>
            <div class="items-center justify-between w-full md:flex md:w-auto md:order-1" id="navbar-search">
                <div id="mobile-search" class="relative mt-3 hidden md:hidden">
                    ...
                    <form method="get" action="items.php" class="flex items-center md:hidden overflow-hidden max-w-xl">
                        <select name="search-type" id="form-mobile-search-list"
                                class="border border-second-500 rounded p-2">
                            <option value="type">PHỤ LIỆU</option>
                            <option value="ma-hang">MÃ HÀNG</option>
                            <option value="po">PO</option>
                        </select>
                        <input type="text" name="search-value" id="search-mobile-input"
                               class="h-full w-full rounded-r-lg border p-2" placeholder="Tìm kiếm...">
                        <button type="submit" class="absolute right-0 bg-blue-600 text-white h-full px-2 rounded-r-lg">
                            <svg class="w-4 h-4" aria-hidden="true" fill="none" viewBox="0 0 20 20">
                ...
                <ul id="main-nav"
                    class="hidden uppercase md:flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <a href="khoang.php"
                           class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
                           aria-current="page">Khoang</a>
                    </li>
                    ...
                    <li>
                        <a href="items.php?het"
                           class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">pl
                            hết</a>
                    </li>
                    <li>
                        <a href="can-doi.php"
                           class="py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 flex items-center">cân
                            đối</a>
...
<div id="toast" class="fixed flex items-center bottom-4 right-4 z-50">
    ...
    <div id="toast-wrap"
         class="border-l-4 flex items-center w-full max-w-xs p-4 bg-<?= $toastType ?>-100 border-<?= $toastType ?>-400 text-<?= $toastType ?>-900 rounded-lg shadow-md"
         role="alert">
        ...
        <button id="close-toast-btn" type="button"
                class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:hover:text-white dark:bg-green-200 dark:hover:bg-green-300">
